...
Private Sub panSiscad_Click()
    ...
    lCgcCpfSiscad = Right$(String(14, "0") & Trim(CStr(mobjstcPed.Num_Cgc_Cpf)), 14)
...
Public Sub mpAtualizaDadosSegurado()
    ...
    lSelect = lSelect & " num_cgc_cpf = '" & Right$(String(18, "0") & Trim(mobjstcPed.Num_Cgc_Cpf), 18) & "'"
    ...
    If Not rsDiversos.EOF Then
        ...
        lSelect = lSelect & " and num_cgc_cpf = '" & Right$(String(18, "0") & Trim(mobjstcPed.Num_Cgc_Cpf), 18) & "'"
