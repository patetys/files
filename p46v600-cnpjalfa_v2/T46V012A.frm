...
Private Function mfBuscarDadosSiscad(pNum_Apol As Double, _
    ...
    lSelect = lSelect & " num_cgc_cpf = '" & Right$(String(18, "0") & Trim(lCPF_CNPJ), 18) & "'"
...
Private Function mfIncluirSiscad(pMensagem As String) As Boolean
    ...
    lInsert = lInsert & gM46V999.gfFormatarCamposSQL(Right$(String(18, "0") & Trim(mobjstcPed.Num_Cgc_Cpf), 18)) & ","
...
Private Function mfAlterarSiscad(pMensagem As String) As Boolean
    ...
    lUpdate = lUpdate & "  where [NUM_CGC_CPF] =" & gM46V999.gfFormatarCamposSQL(Right$(String(18, "0") & Trim(mobjstcPed.Num_Cgc_Cpf), 18))
