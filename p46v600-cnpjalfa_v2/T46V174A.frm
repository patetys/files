        ...
        For Each objstcPedido In objPedido.Colecao
            For Each lobjstcPedLoc In objstcPedido.ColecaoPedLoc
                If lobjstcPedLoc.Insp_Obr = True And lobjstcPedLoc.Insp_Agend = False Then
                    ...
                    Case Is > 11
                        Call gM46V999.gpForCNPJ(1, Right$(String(14, "0") & Trim(CStr(objstcPedido.Num_Cgc_Cpf)), 14), lCpfCnpj)
                    Case Else
                        Call gM46V999.gpForCPF(1, Right$(String(11, "0") & Trim(CStr(objstcPedido.Num_Cgc_Cpf)), 11), lCpfCnpj)
                    End Select
...
Function mfPesqCotAgend()
    ...
    If gM46V999.gTipUsuario = e_Tipo_Usu_Corretor Or gM46V999.gTipUsuario = e_Tipo_Usu_CorretorYasuda Then
        ...
        Do While Not lrst.EOF
            ...
            Select Case Len(Trim(CStr(lrst("Num_Cgc_Cpf"))))
            Case Is > 11
                Call gM46V999.gpForCNPJ(1, Right$(String(14, "0") & Trim(CStr(lrst("Num_Cgc_Cpf"))), 14), lCpfCnpj)
            Case Else
                Call gM46V999.gpForCPF(1, Right$(String(11, "0") & Trim(CStr(lrst("Num_Cgc_Cpf"))), 11), lCpfCnpj)
            End Select
