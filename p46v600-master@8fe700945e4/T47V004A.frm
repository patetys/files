...
Private Sub cmdSiscad_Click(Index As Integer)
    ...
    If Index = 0 Then
        If Dir(gM46V999.gEndExeSiscad) <> "" Then
            Call Shell(gM46V999.gEndExeSiscad & " " & Format(lCPF_CNPJ, String(14, "0")) & Format(frmT47V001A.objstcPedido.objstcCtrlEmis.Num_PI, String(10, "0")), vbNormalFocus)
        End If
