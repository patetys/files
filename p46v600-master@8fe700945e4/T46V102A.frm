...
Begin VB.Form frmT46V102A 
   ...
   Begin VB.TextBox txtDatEmis 
      ...
      MaxLength       =   10
      TabIndex        =   104
      ToolTipText     =   "Data agendada para emissão"
      Top             =   7710
      Width           =   1140
   End
   Begin VB.TextBox txtDigCodSegurado 
      ...
      MaxLength       =   2
      TabIndex        =   137
      ToolTipText     =   "Código do segurado."
      Top             =   285
      Width           =   300
   End
   Begin VB.TextBox txtReferencia 
      ...
      MaxLength       =   15
      TabIndex        =   95
      ToolTipText     =   "Referência do Corretor"
      Top             =   7350
      Width           =   1515
   End
   Begin VB.ComboBox CmbTipCotac 
      ...
      Style           =   2  'Dropdown List
      TabIndex        =   11
      ToolTipText     =   "Tipo de Cotação (se houver)"
      Top             =   285
      Width           =   1575
   End
   Begin VB.TextBox txtNumSiscota 
      ...
      MaxLength       =   12
      TabIndex        =   12
      ToolTipText     =   "Número da Cotação (SisCota)"
      Top             =   285
      Width           =   1770
   End
   ...
   Begin Threed.SSPanel panProduto 
      ...
      Left            =   5400
      TabIndex        =   72
      ToolTipText     =   "Dados e opções do produto."
      Top             =   5115
      Width           =   3600
      _Version        =   65536
      _ExtentX        =   6350
      ...
      Begin Threed.SSPanel panProp 
         ...
         Begin VB.OptionButton optPagAntecipado 
            ...
            Left            =   1200
            TabIndex        =   125
            ToolTipText     =   "NÃO tem pagamento antecipado."
            Top             =   380
            Width           =   1900
         End
         Begin Threed.SSCommand cmdPagAntBloqueto 
            ...
            TabIndex        =   124
            TabStop         =   0   'False
            ToolTipText     =   "Exibir informações de pagamento antecipado."
            Top             =   70
            Width           =   240
            _Version        =   65536
            _ExtentX        =   423
      ...
      Begin Threed.SSPanel panProp 
         ...
         Begin VB.OptionButton optForPagamento 
            ...
            Left            =   1200
            TabIndex        =   147
            ToolTipText     =   "Pagamento através de débito em conta corrente."
            Top             =   1100
            Width           =   1875
         End
         Begin VB.OptionButton optForPagamento 
            Caption         =   "Débito automático com 1º em boleto"
            ForeColor       =   &H00800000&
            Height          =   330
            Index           =   2
            Left            =   1200
         ...
         Begin VB.OptionButton optForPagamento 
            ...
            Left            =   1200
            TabIndex        =   112
            ToolTipText     =   "Pagamento através de carnê."
            Top             =   120
            Width           =   750
         End
         Begin VB.OptionButton optForPagamento 
            Caption         =   "Débito em c/c"
            ForeColor       =   &H00800000&
            Height          =   195
            Index           =   1
            Left            =   1200
         ...
         Begin Threed.SSCommand cmdForPagCarne 
            ...
            TabIndex        =   113
            TabStop         =   0   'False
            ToolTipText     =   "Exibir informações de forma de pagamento."
            Top             =   100
            Width           =   240
            _Version        =   65536
            _ExtentX        =   423
      ...
      Begin Threed.SSPanel panProp 
         ...
         Begin VB.OptionButton optVencimento 
            ...
            Left            =   1200
            TabIndex        =   133
            ToolTipText     =   "Não ajustar a data das parcelas"
            Top             =   345
            Width           =   1400
         End
         Begin VB.OptionButton optVencimento 
      ...
      Begin Threed.SSPanel panProp 
         ...
         Begin Threed.SSPanel panProp 
            ...
            _ExtentY        =   450
            _StockProps     =   15
            Caption         =   "Meio para dev cred futuros - Restituição"
            ForeColor       =   8388608
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
   ...
   Begin Threed.SSPanel panCorretores 
      ...
      Begin VB.TextBox txtCorComissao 
         ...
         TabIndex        =   81
         Text            =   "0,00"
         ToolTipText     =   "Comissão do terceiro corretor."
         Top             =   890
         Width           =   700
      End
      Begin VB.TextBox txtCorComissao 
         ...
         TabIndex        =   79
         Text            =   "0,00"
         ToolTipText     =   "Comissão do segundo corretor."
         Top             =   600
         Width           =   700
      End
      Begin VB.TextBox txtCorComissao 
         ...
         TabIndex        =   77
         Text            =   "0,00"
         ToolTipText     =   "Comissão do primeiro corretor."
         Top             =   320
         Width           =   700
      End
      Begin VB.Label lblProp 
   ...
   Begin Threed.SSPanel panEndereco 
      ...
      Begin Threed.SSPanel panProp 
         ...
         Left            =   2310
         TabIndex        =   63
         ToolTipText     =   "Endereço de cobrança é diferente do endereço do segurado?"
         Top             =   1275
         Width           =   1650
         _Version        =   65536
         _ExtentX        =   2910
         ...
         Begin VB.OptionButton optEndCobranca 
            ...
            Left            =   645
            TabIndex        =   65
            ToolTipText     =   "NÃO, endereço de cobrança é igual ao endereço do segurado."
            Top             =   50
            Width           =   600
         End
         Begin VB.OptionButton optEndCobranca 
            ...
            Left            =   45
            TabIndex        =   64
            ToolTipText     =   "SIM, endereço de cobrança é diferente do endereço do segurado."
            Top             =   50
            Width           =   600
         End
         Begin Threed.SSCommand cmdEndCobranca 
            ...
            TabIndex        =   66
            TabStop         =   0   'False
            ToolTipText     =   "Exibir endereço de cobrança."
            Top             =   15
            Width           =   255
            _Version        =   65536
            _ExtentX        =   441
      ...
      Begin VB.Label lblProp 
         Alignment       =   1  'Right Justify
         BorderStyle     =   1  'Fixed Single
         Caption         =   "Endereço cobrança diferente?"
         ForeColor       =   &H00800000&
         Height          =   285
         Index           =   9
         Left            =   45
   ...
   Begin Threed.SSPanel panProp 
      ...
      Begin Threed.SSCommand cmdCosseguro 
         ...
         TabIndex        =   93
         TabStop         =   0   'False
         ToolTipText     =   "Exibir informações de cosseguro."
         Top             =   600
         Width           =   285
         _Version        =   65536
         _ExtentX        =   503
      ...
      Begin Threed.SSPanel panProp 
         ...
         Begin VB.OptionButton optCosseguro 
            ...
            Left            =   650
            TabIndex        =   92
            ToolTipText     =   "NÃO tem cessão de cosseguro."
            Top             =   50
            Width           =   600
         End
         Begin VB.OptionButton optCosseguro 
            ...
            Left            =   50
            TabIndex        =   91
            ToolTipText     =   "SIM, tem cessão de cosseguro."
            Top             =   50
            Width           =   600
         End
      End
      Begin VB.Label lblProp 
         Alignment       =   1  'Right Justify
         BorderStyle     =   1  'Fixed Single
         Caption         =   "Cessão de cosseguro? "
         ForeColor       =   &H00800000&
         Height          =   285
         Index           =   12
         Left            =   50
         TabIndex        =   89
         ToolTipText     =   "Cessão de cosseguro?"
         Top             =   600
         Width           =   1850
      End
   ...
   Begin Threed.SSPanel panPesFisica 
      ...
      Begin VB.ComboBox cboRendaMensal 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   42
         ToolTipText     =   "Renda Mensal - Pessoa Física"
         Top             =   960
         Width           =   4185
      End
      Begin VB.TextBox txtIdeEmpresa 
         ...
         MaxLength       =   30
         TabIndex        =   40
         ToolTipText     =   "Número do documento de identificação do segurado."
         Top             =   960
         Width           =   2050
      End
      Begin VB.TextBox txtIdeDatEmissao 
         ...
         MaxLength       =   10
         TabIndex        =   26
         ToolTipText     =   "Data de emissão do documento de identificação do segurado."
         Top             =   50
         Width           =   1470
      End
      Begin VB.TextBox txtIdeOrgExpedidor 
         ...
         MaxLength       =   20
         TabIndex        =   30
         ToolTipText     =   "Órgão expedidor do documento de identificação do segurado."
         Top             =   345
         Width           =   1125
      End
   ...
   Begin Threed.SSPanel panPesJuridica 
      ...
      Begin VB.ComboBox cboFaturamento 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   19
         ToolTipText     =   "Faturamento - Pessoa Jurídica"
         Top             =   480
         Width           =   5505
      End
   ...
   Begin Threed.SSPanel panProlabore 
      ...
      Begin VB.OptionButton optProlabore 
         ...
         Left            =   1605
         TabIndex        =   99
         ToolTipText     =   "NÃO tem prolaborista."
         Top             =   50
         Width           =   600
      End
      Begin Threed.SSCommand cmdProlabore 
         ...
         TabIndex        =   100
         TabStop         =   0   'False
         ToolTipText     =   "Exibir informações dos prolaboristas."
         Top             =   0
         Width           =   285
         _Version        =   65536
         _ExtentX        =   503
   ...
   Begin VB.Label lblProp 
      Alignment       =   1  'Right Justify
      BorderStyle     =   1  'Fixed Single
      Caption         =   "Cód. segurado: "
      ForeColor       =   &H00800000&
      Height          =   315
      Index           =   26
      Left            =   0
      TabIndex        =   7
      ToolTipText     =   "Código e nome do segurado."
      Top             =   285
      Width           =   1215
   End
   Begin VB.Label lblProp 
...
Private mAltEndereco As Boolean         'Indica que houve alteração no endereço.
...
Private Sub mpUnidadeSegurado(ByRef pUnidade As Integer, ByRef pMensagem As String)
    Dim lbdP0044700 As ADODB.Connection    'Arquivo de conexão.
...
'Parâmetro de saída.....pMensagem......Mensagem.
    ...
    Dim lCodUniProdAux As Integer    'Código da unidade produtiva auxiliar
    ...
    Dim lListarUnidade As Boolean    'Indicador se é para listar as unidades para o usuários escolher
    ...
    '****-- 0501113 - Disponibilizada opção de seleção da unidade quando corretora com mais de um registro
    '****--           na TAB_UNID_CORR_PROD para todos os usuários do Syas.
...
'1. Se não houve alteração no endereço, não verificar.
    ...
    If lTamanho > 50 Then
        Call gM46V999.gpGraLog(1, "AGE0035 - " & gM46V999.gPrefixo & "Endereço completo do segurado: " & vbLf & vbLf & _
...
'            Qualquer alteração deve ser feita na propriedade LIST do controle.
    ...
    Call gpHabSalvar
    If optEndCobranca(1) = True Then    'Endereço de cobrança igual.
...
Private Sub cmdExcluir_Click()
    ...
    With flxTelefones
        If .Rows > 2 Then
            ...
            'Resize da coluna de observação
            .Col = 5
            .ColSel = .Col
            If .Rows > 5 Then
...
Private Sub cmdSiscad_Click(index As Integer)
    ...
    If optTipPessoa(0).Value = True Then    'Física
    ...
    If index = 0 Then
        If Dir(gM46V999.gEndExeSiscad) <> "" Then
            Call Shell(gM46V999.gEndExeSiscad & " " & Format(lCPF_CNPJ, String(14, "0")) & "0" & Format(frmT46V101A.objstcPedido.objstcCtrlEmis.NUM_PI, String(10, "0")), vbNormalFocus)
        End If
...
ControleErro:
    If Err.Number = 53 Then
        Call gM46V999.gpGraLog(1, "FTE0025 - Arquivo não localizado: Sistema SISCAD (Verificar endereço informado no arquivo de inicialização).")
    End If
End Sub
...
'1. Torna form invisível.
    ...
    If frmT46V101A.lblTipDocumento.Caption = "2" Then   'Proposta.
        If optForPagamento(0).Enabled = True Then
            If optForPagamento(0) = True Then   'Carnê.
                With frmT46V109A
                    ...
                    End If
                End With
            ElseIf optForPagamento(1) = True Then    'Débito em conta.
                With frmT46V110A
                    ...
                    End If
                End With
            ElseIf optForPagamento(2) = True Then    'Débito automático com 1º em boleto.
                With frmT46V185A
            ...
            ElseIf CLng(txtQuaParcelas.Text) <> 0 Then   'Nada selecionado.
                Call gM46V999.gpGraLog(1, "FGE0085 - Forma de pagamento inválida (não selecionada).")
...
Private Sub Form_Activate()
    ...
    If gM46V999.gfPreenchido(gProChamado) Then
        ...
        Case "T46V125A"     'Grade de itens.
            'Nada a fazer.
            'Ficha 1000307
        Case "T46V111A"     'Lista de classificações
    ...
    Case e_Tipo_Usu_Corretor, e_Tipo_Usu_CorretorYasuda
        ...
        If gM46V999.gNovaTransmissaoMulti = True Then
            If gM46V999.gTipUsuario = e_Tipo_Usu_Corretor Then
                If frmT46V112A.optTipEmissao(1).Value = True Then  'Renovação
                    If frmT46V101A.optTipPessoa(0).Value = True Then
                        Call gM46V999.gpForCPF(2, txtCnpj.Text, mAtuCNPJ)  'Física
                    Else
                        Call gM46V999.gpForCNPJ(2, txtCnpj.Text, mAtuCNPJ)    'Jurídica
                    End If
...
Public Sub mpAtualizaDadosSegurado(ByRef pContemDados As Boolean, pConfirmar As Boolean)
    ...
    If pConfirmar = True Then    'SisCadAberto 1
        ...
        MsgBox "Pressione Ok, após terminar de atualizar os dados do SisCad!", vbOKOnly, Me.Caption
    End If
    ...
    Else    'Jurídica
        Call gM46V999.gpForCNPJ(2, txtCnpj.Text, lCPF_CNPJ)
    End If
    If gM46V999.gfPreenchido(lCPF_CNPJ) And lCPF_CNPJ <> 0 Then  'CNPJ_CPF.
        ...
        If Not rsSisCad.EOF Then
            ...
            If lLibAltNome = True And pConfirmar = True Then
                If MsgBox("Nome do segurado liberado para alteração!" & vbCrLf & "Atualizar tela com os dados do SISCAD?", vbYesNo + vbQuestion, Me.Caption) = vbYes Then
                    lLibAltNome = False
                End If
            End If
            If lLibAltEnd = True And pConfirmar = True Then
                If MsgBox("Endereço do segurado e cobrança liberados para alteração!" & vbCrLf & "Atualizar tela com os dados do SISCAD?", vbYesNo + vbQuestion, Me.Caption) = vbYes Then
                    lLibAltEnd = False
                End If
            End If
            ...
            'Ficha 900417
            'A partir da versão 968 este campo irá conter a PROFISSÃO e não mais o local de trabalho
            If gM46V999.gCodProduto >= 968 Then
            ...
            Case "Q"
                ...
                'Ficha 1000365 - Inclusão Ramos de Atividade
            Case "R"
            ...
            lSelect = lSelect & " and num_cgc_cpf = " & lCPF_CNPJ
...
Private Sub Form_Load()
    ...
    '3. Carrega combo de ramos de atividade para pessoa jurídica.
    With cboRamAtividade
        .AddItem "Agricultura, pecuária, produção florestal, pesca e aquicultura"
        .ItemData(.NewIndex) = 1
        .AddItem "Indústria extrativa"
        .ItemData(.NewIndex) = 2
        .AddItem "Indústria de transformação"
        .ItemData(.NewIndex) = 3
        .AddItem "Eletrecidade e gás"
        .ItemData(.NewIndex) = 4
        .AddItem "Água, esgoto, atividades de gestão de resíduos e descontaminação"
        .ItemData(.NewIndex) = 5
        .AddItem "Construção"
        .ItemData(.NewIndex) = 6
        .AddItem "Comércio; Reparação de veículos automotores e motocicletas"
        .ItemData(.NewIndex) = 7
        .AddItem "Transporte, armazenagem ou comunicações"
        .ItemData(.NewIndex) = 8
        .AddItem "Alojamento e alimentação"
        .ItemData(.NewIndex) = 9
        .AddItem "Informação e comunicação"
        .ItemData(.NewIndex) = 10
        .AddItem "Atividades financeiras, de seguros e serviços relacionados"
        .ItemData(.NewIndex) = 11
        .AddItem "Atividades imobiliárias"
        .ItemData(.NewIndex) = 12
        .AddItem "Atividades profissionais, científicas e técnicas"
        .ItemData(.NewIndex) = 13
        .AddItem "Atividades administrativas e serviços complementares"
        .ItemData(.NewIndex) = 14
        .AddItem "Administração pública, defesa e seguridade social"
        .ItemData(.NewIndex) = 15
        .AddItem "Educação"
        .ItemData(.NewIndex) = 16
        .AddItem "Saúde humana e serviços sociais"
        .ItemData(.NewIndex) = 17
        .AddItem "Artes, cultura, esporte e recreação"
        .ItemData(.NewIndex) = 18
        .AddItem "Outras atividades de serviços"
        .ItemData(.NewIndex) = 19
        .AddItem "Serviços domésticos"
        .ItemData(.NewIndex) = 20
        .AddItem "Organismos internacionais e outras instituições extraterritoriais"
        .ItemData(.NewIndex) = 21
    End With

    '4. Carrega combo de tipos de documento de identificação para pessoa jurídica.
    '[FRH] - F.900530
...
''            .AddItem "Certidão de casamento"
''            .ItemData(.NewIndex) = 4
''            .AddItem "Certidão de nascimento"
''            .ItemData(.NewIndex) = 5
...
''        End If
    ...
    'Fichas 1200168 e 1200169 Inclusão dos campos de listagem Renda e Faixa de Faturamento Pessoa física e jurídica
    With cboFaturamento
        .AddItem "Não desejo informar": .ItemData(.NewIndex) = 0
        .AddItem "Até R$ 500 mil": .ItemData(.NewIndex) = 1
        .AddItem "De R$ 500 mil a 1 milhão": .ItemData(.NewIndex) = 2
        .AddItem "De R$ 1 milhão a 3 milhões": .ItemData(.NewIndex) = 3
        .AddItem "De R$ 3 milhões a 6 milhões": .ItemData(.NewIndex) = 4
        .AddItem "De 6 milhões a 15 milhões": .ItemData(.NewIndex) = 5
        .AddItem "De 15 milhões a 40 milhões": .ItemData(.NewIndex) = 6
        .AddItem "De R$ 40 milhões a 80 milhões": .ItemData(.NewIndex) = 7
        .AddItem "De R$ 80 milhões a 150 milhões": .ItemData(.NewIndex) = 8
        .AddItem "Acima de 150 milhões": .ItemData(.NewIndex) = 9
        .ListIndex = -1
    End With
    ...
    With cboRendaMensal
        .AddItem "Não desejo informar": .ItemData(.NewIndex) = 0
        .AddItem "Menor ou igual a ½ salário mínimo": .ItemData(.NewIndex) = 1
        .AddItem "Maior que ½ salário mínimo até1 salário mínimo": .ItemData(.NewIndex) = 2
        .AddItem "Maior que 1 salário mínimo até2 salários mínimos": .ItemData(.NewIndex) = 3
        .AddItem "Maior que 2 salários mínimos até 3 salários mínimos": .ItemData(.NewIndex) = 4
        .AddItem "Maior que 3 salários mínimos até 5 salários mínimos": .ItemData(.NewIndex) = 5
        .AddItem "Maior que 5 salários mínimos até 10 salários mínimos": .ItemData(.NewIndex) = 6
        .AddItem "Maior que 10 salários mínimos até 20 salários mínimos": .ItemData(.NewIndex) = 7
        .AddItem "Maior que 20 salários mínimos": .ItemData(.NewIndex) = 8
    End With

    '[FRH]-> Se usuário corretor..
    '1001046 - Telefone do Segurado 8 Digitos
...
Private Sub optEndCobranca_Click(index As Integer)
    ...
    Case 1      'Não tem endereço de cobrança diferente
...
Private Sub optForPagamento_Click(index As Integer)
    ...
    Case 1  'Débito automático.
        ...
        If gM46V999.gfDisponivel("frmT46V185A") Then
            Unload frmT46V185A
        End If
    Case 2  'Débito automático com 1º em boleto.
...
Private Sub optPagAntecipado_Click(index As Integer)
    ...
    Case 1  'Sim - Antecipado.
        ...
        If gCarga = False Then
            ...
            If gM46V999.gTipUsuario = e_Tipo_Usu_Yasuda And optForPagamento(0).Value = True Then
                'Somente com usuário yasuda é que
                'poderá digitar o número do boleto. Caso contrário este
                'número será gerado na rotina de impressão de formulário.
                frmT46V108A.Show vbModal, Me
            End If
        End If
        If gM46V999.gfDisponivel("frmT46V110A") = True Then
        ...
        If txtValorPgAnt.Visible Then
            txtValorPgAnt.Enabled = True
            If txtValorPgAnt.Enabled = True Then txtValorPgAnt.SetFocus    'Exibe mensagem "Invalid procedure call" se ainda não estiver pronto.
        End If
    Case 2  'Não - a 30 dias.
    ...
    txtJuros.Text = Format(frmT46V142A.getJuros(IIf(optForPagamento(0).Value, e_FormaPagamento_Carne, e_FormaPagamento_Debito), optPagAntecipado(1).Value, val(txtQuaParcelas.Text)), "standard")
    Call txtQuaParcelas_LostFocus   'Considera informação de quantidade de parcelas.
End Sub
...
Private Sub optProlabore_Click(index As Integer)
    ...
    Case 1  'Não.
        lMensagem = "AGE0016 - " & gM46V999.gPrefixo & "Excluída opção de prolabore. " & _
                    "Lista de prolaboristas será desconsiderada. Confirma esta opção?"
...
Private Sub optVencimento_Click(index As Integer)
    ...
    Case 0  'Sim.
        ...
        If txtQuaParcelas = 1 And optPagAntecipado(1).Value = True Then
            lMensagem = "FGE0120 - Não é permitido ajustar vencimento quando somente uma parcela."
            MsgBox lMensagem
    ...
    Case 1  'Não.
        lMensagem = "AGE0016 - " & gM46V999.gPrefixo & "Excluída opção de ajuste de vencimento. " & _
                    "Datas ajustadas serão desconsideradas. Confirma esta opção?"
        If MsgBox(lMensagem, vbQuestion + vbYesNo + vbDefaultButton2) = vbYes Then
            Call gM46V999.gpGraLog(0, lMensagem & " Sim.")
            On Error Resume Next
            Unload frmT46V121A
...
Private Sub Text1_LostFocus()
    ...
    If lcol = 3 And Trim(Text1.Text) <> "" Then
        If Mid(Text1.Text, 1, 1) = 0 Then
           MsgBox "Telefone Inválido, número começando com zero. Favor Verificar!", vbCritical, "Atenção"
           Text1.Text = ""
           flxTelefones.TextMatrix(lrow, lcol) = Text1.Text
           'Text1.SetFocus
           Exit Sub
        ...
        If Len(Text1.Text) < 8 Then
           MsgBox "Telefone Inválido, número inferior a 8 dígitos. Favor Verificar!", vbCritical, "Atenção"
           Text1.Text = ""
           flxTelefones.TextMatrix(lrow, lcol) = Text1.Text
           'Text1.SetFocus
           Exit Sub
        ...
        If Not VALIDATEXTO(Text1.Text) Then
           MsgBox "Telefone Inválido/Viciado. Favor Verificar!", vbCritical, "Atenção"
           Text1.Text = ""
           flxTelefones.TextMatrix(lrow, lcol) = Text1.Text
           'Text1.SetFocus
           Exit Sub
...
Private Sub txtIdeNumDocumento_LostFocus()
    If Not VALIDATEXTO(txtIdeNumDocumento.Text) And gM46V999.gfPreenchido(txtIdeNumDocumento.Text) Then
       MsgBox "Numero do documento Inválido. Favor Verificar!", vbInformation, "Atenção"
...
Public Sub txtCorretor_LostFocus(index As Integer)
    ...
    '1. Se código do corretor preenchido, encerrar processo.
    ...
    If IsNumeric(lCorretor) And Len(CStr(val(lCorretor))) <= 6 Then
        ...
        If index = 1 And gCodCorrInst <> lSaida(1, 1) And gCodCorrInst <> 0 And gM46V999.gCodProtocolo = 0 Then
            ...
            If gM46V999.gfVerCorrPermitido_TBS_Corr_Grupo(gCodCorrInst, lSaida(1, 1), CInt(gM46V999.gCod_Ramo), lMensagem) = False Then
                Call gM46V999.gpGraLog(1, "FGE0017 - Código corretor não permitido para este usuário (" & gM46V999.gNomUsuario & ")")
                txtCorretor(index).Text = ""
                If txtCorretor(index).Visible = True And txtCorretor(index).Enabled = True Then
                    txtCorretor(index).SetFocus
                End If
...
Private Sub txtCorretor_Validate(index As Integer, Cancel As Boolean)
    ...
    With frmT46V180A
        ...
        Do While intlinhaGrid < .flxProlaboristas.Rows
            'refaz a numeração das colunas no grid.
            ...
            If LTrim(RTrim(strCorretor)) = LTrim(RTrim(.flxProlaboristas.TextMatrix(intlinhaGrid, 1))) Then
                If .flxProlaboristas.Rows = 2 Then
                    ...
                    'caso não reste mais prolaboristas, deve setar para não a opção.
                    gCarga = True
                    optProlabore(1).Value = True
                    gCarga = False
                    Exit Do
...
If Len(Z) < 6 Then
    VALIDATEXTO = False
Else
    'Recebe o primeiro caractere da string em código asc.
    G = Asc(Left(Z, 1))
    H = 0
    'F recebe a segunda posição de Z.
    For f = 2 To Len(Z)
...
'Verifica data.
    ...
    If CDate(txtIdeDatEmissao.Text) >= Date Then
       MsgBox "A data de emissão deverá ser menor que a data atual.", vbCritical, "Atenção"
       txtIdeDatEmissao.Text = ""
       Exit Sub
    End If
...
'Verifica data.
    ...
    If CDate(txtDataNascimento.Text) >= Date Then
       MsgBox "A data de nascimento deverá ser menor que a data atual.", vbCritical, "Atenção"
       txtDataNascimento.Text = ""
       Exit Sub
    End If
...
'Procedure: obtém Reg.Conselho.
    ...
    Dim lCod_Clasf As String  'Código da Classificação
    Dim lCod_Compl_Clasf As String        'Complemento da Classificação
    Dim lSelect As String
    ...
    '2. Obtém Reg.Conselho informado.
    ...
    lSelect = lSelect & " and b.Cod_Clasf = '" & Trim(lCod_Clasf) & "'"    '1000871 - Inclusão de Orgão Categoria Conselho
    lSelect = lSelect & " and b.Cod_Compl_Clasf = '" & Trim(lCod_Compl_Clasf) & "'"    '1000871 - Inclusão de Orgão Categoria Conselho
