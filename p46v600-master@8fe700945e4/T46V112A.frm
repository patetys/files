...
'1. Posiciona tipo de emissão.
    ...
    ElseIf optTipEmissao(1) = True Then     'Renovação Yasuda.
        lTipEmissao = 200
    ElseIf optTipEmissao(2) = True Then     'Renovação de congênere.
        lTipEmissao = 101
        ...
        If cboDizer.ItemData(cboDizer.ListIndex) <> e_CodDizerInclusao Then
            ...
            If Not IsNumeric(txtRenItem.Text) Then
                Call gM46V999.gpGraLog(1, "FGE0072 - " & gM46V999.gPrefixo & _
                                          "Número do item da apólice inválido (Endosso Yasuda - não numérico).")
                If txtRenItem.Visible = True And txtRenItem.Enabled = True Then
                    txtRenItem.SetFocus
                End If
                Exit Sub
            ...
            If val(txtRenItem.Text) = 0 Then
                Call gM46V999.gpGraLog(1, "FGE0070 - " & gM46V999.gPrefixo & _
                                          "Número do item da apólice inválido (Endosso Yasuda - zerado).")
                If txtRenItem.Visible = True And txtRenItem.Enabled = True Then
                    txtRenItem.SetFocus
                End If
                Exit Sub
...
Private Sub Form_Activate()
    ...
    Me.Caption = " Tipo de Emissão  -  PI: " & frmT46V101A.objstcPedido.NUM_PI
    PosicionaObj
Finalizar:
...
Private Sub Form_Load()
    ...
    cboDizer.AddItem "Alterações"
    cboDizer.ItemData(cboDizer.NewIndex) = 12

    cboDizer.AddItem "Inclusão de item"
    cboDizer.ItemData(cboDizer.NewIndex) = 1

    cboDizer.AddItem "Exclusão de item"
    ...
    cboCodReg.AddItem "002-Apólice sem cobrança de IOF e custo"
    ...
    '8000047867, Código de registro
    'cboCodReg.AddItem "020-Apólice a averbar (sem cobrança de prêmio)"
    cboCodReg.AddItem "101-Endosso com cobrança de prêmio"
    ...
    cboCodReg.AddItem "129-Endosso de cancelamento de apólice sem devolução de prêmio"
...
Private Sub optTipEmissao_Click(index As Integer)
    ...
    If gM46V999.gfDisponivel("frmT46V117A") And frmT46V101A.cboPlano.ListIndex > -1 Then
        ' CR1425 - Quando for plano, não tem bonus
    ...
    Else
        ...
        '        'Se antes era congenere e agora não é , então acrescentar 5 no bonus
        ...
        '        'Se antes não era congenere e agora é , então retirar 5 do bonus
        '        frmT46V101A.txtDescBonus.Text = Val(frmT46V101A.txtDescBonus.Text) - 5
        '    End If
        'End If
        mTipEmissaoAnt = mTipEmissao
