...
Private Sub cmdOk_Click()
    ...
    With flxProdutos
        ...
        frmT46V101A.objstcPedido.Cod_Protocolo = gM46V999.gCodProtocolo
        frmT46V101A.objstcPedido.Cod_Produto = gM46V999.gCodProduto
        frmT46V101A.objstcPedido.Cod_Sequencia = gM46V999.gCodSequencia
        Set frmT46V101A.objstcPedido.getProduto.stcOrigem = frmT46V101A.objstcPedido
    End With
...
Private Sub Form_Load()
    ...
    With flxProdutos
        If gM46V999.gfAbrBasDados("P00MULTI", gM46V999.gTipP00MULTI, gM46V999.gEndP00MULTI, bdTAB_PROD, lMensagem) = False Then
        ...
        pProdFinalizado = 0
        If Trim(gM46V999.gTarifaTeste) <> "" Then
            pProdFinalizado = 9
        End If
    
        'Lucas Garcia - Liberar Tarifa Um Dia Antes Da Passagem.
        If pProdFinalizado > 0 Then
            lSelect = lSelect & " AND PROD_FINALIZADO IN (9,1) " '9 = EmTeste
        Else
