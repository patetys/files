...
Private Sub CarregaGrid()
    ...
    If Val_Pr_Tot_Orig = 0 Or mobjstcPed.Cod_Sit_Ped = e_SitPedido_SemCalculo Then
...
Private Sub txtValPremioInformado_LostFocus()
    ...
    If CCur(ValPrInf - Val_Pr_Liq) >= 0.01 Then
