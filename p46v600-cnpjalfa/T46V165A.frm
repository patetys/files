...
Begin VB.Form frmT46V165A 
   ...
   Begin Threed.SSPanel panRenCongenere 
      ...
      Begin VB.ComboBox cboClausulas 
         ...
         Height          =   315
         Index           =   9
         ItemData        =   "T46V165A.frx":030A
         Left            =   90
         List            =   "T46V165A.frx":030C
         Sorted          =   -1  'True
      ...
      Begin VB.ComboBox cboClausulas 
         ...
         Height          =   315
         Index           =   8
         ItemData        =   "T46V165A.frx":030E
         Left            =   90
         List            =   "T46V165A.frx":0310
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   9
         ToolTipText     =   "Cláusulas"
      ...
      Begin VB.ComboBox cboClausulas 
         ...
         Height          =   315
         Index           =   7
         ItemData        =   "T46V165A.frx":0312
         Left            =   90
         List            =   "T46V165A.frx":0314
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   8
         ToolTipText     =   "Cláusulas"
      ...
      Begin VB.ComboBox cboClausulas 
         ...
         Height          =   315
         Index           =   1
         ItemData        =   "T46V165A.frx":0316
         Left            =   90
         List            =   "T46V165A.frx":0318
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   7
         ToolTipText     =   "Cláusulas"
      ...
      Begin VB.ComboBox cboClausulas 
         ...
         Height          =   315
         Index           =   2
         ItemData        =   "T46V165A.frx":031A
         Left            =   90
         List            =   "T46V165A.frx":031C
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   6
         ToolTipText     =   "Cláusulas"
      ...
      Begin VB.ComboBox cboClausulas 
         ...
         Height          =   315
         Index           =   3
         ItemData        =   "T46V165A.frx":031E
         Left            =   90
         List            =   "T46V165A.frx":0320
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   5
         ToolTipText     =   "Cláusulas"
      ...
      Begin VB.ComboBox cboClausulas 
         ...
         Height          =   315
         Index           =   4
         ItemData        =   "T46V165A.frx":0322
         Left            =   90
         List            =   "T46V165A.frx":0324
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   4
         ToolTipText     =   "Cláusulas"
      ...
      Begin VB.ComboBox cboClausulas 
         ...
         Height          =   315
         Index           =   5
         ItemData        =   "T46V165A.frx":0326
         Left            =   90
         List            =   "T46V165A.frx":0328
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   3
         ToolTipText     =   "Cláusulas"
      ...
      Begin VB.ComboBox cboClausulas 
         ...
         Height          =   315
         Index           =   6
         ItemData        =   "T46V165A.frx":032A
         Left            =   90
         List            =   "T46V165A.frx":032C
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   2
         ToolTipText     =   "Cláusulas"
   ...
   End
End
Attribute VB_Name = "frmT46V165A"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Public ClausulaItem As Integer
...
Private Sub cmdOk_Click()
    ...
    For i = 1 To 9
        ...
        End If
    Next i
    ClausulaItem = frmT46V101A.objstcPedLoc.Num_Item
...
Private Sub Form_Load()
    ...
    Case e_CodRamo_Residencial, e_CodRamo_Empresarial, e_CodRamo_Condominio
        'Ass24h.
        lSelect = gM46V999.gfWhereAnd(lSelect) & "Cod_Clau not in(400,401,402)"
    End Select
