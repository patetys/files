...
Begin VB.Form frmT46V182A 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Inclusão de Proprietário"
   ClientHeight    =   2145
   ClientLeft      =   2085
   ClientTop       =   1800
   ClientWidth     =   5925
   ControlBox      =   0   'False
   Icon            =   "T46V182A.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame fraDocumento 
      ...
      Begin VB.ComboBox cboIdeTipDocumento 
         ForeColor       =   &H00800000&
         Height          =   315
         ItemData        =   "T46V182A.frx":000C
         Left            =   630
         List            =   "T46V182A.frx":000E
   ...
   Begin VB.ComboBox cmbTpPessoa 
      ...
      ForeColor       =   &H00800000&
      Height          =   315
      ItemData        =   "T46V182A.frx":0010
      Left            =   1140
      List            =   "T46V182A.frx":001A
      Style           =   2  'Dropdown List
      TabIndex        =   3
      Top             =   480
      Width           =   1395
...
Private Sub cmdOk_Click()
    If Trim(txtProprietario.Text) = Empty Or cmbTpPessoa.Text = Empty Or Trim(txtCpfCnpj.Text) = Empty Then
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    ...
    lMensagem = "AGE0016 - " & gM46V999.gPrefixo & "Excluída opção de propietário. " & _
                "Confirma esta opção?"
    If MsgBox(lMensagem, vbQuestion + vbYesNo + vbDefaultButton2) = vbYes Then
        Call gM46V999.gpGraLog(0, lMensagem & " Sim.")
        gCarga = True
        frmT46V101A.optProprietario(0).Value = False
        frmT46V101A.optProprietario(1).Value = True
        gCarga = False
        Call gM46V999.gpGraLog(0, lMensagem & " Sim.")
...
Public Sub CarregarDados(ByRef pPessoa As stcA46V735B)
    ...
    txtProprietario.Text = pPessoa.Nom_Pessoa
...
Public Sub SalvarDados(ByRef pPessoa As stcA46V735B)
    ...
    With pPessoa
        .Tip_Loc_Pessoa = e_TipLocPessoa_Proprietario
        .Nom_Pessoa = gM46V999.gfRetirarCaracterEspecial(txtProprietario.Text, True)
