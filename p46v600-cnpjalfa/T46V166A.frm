...
Private Sub cmdBusca_Click()
    ...
    If gM46V999.CDblx(txtCodDizer) = 8500 Then
        If gM46V999.gfDisponivel("frmT46V155A") Then
            MsgBox "Mensagem Padrão '" & txtCodDizer & "' já está sendo utilizada para beneficiários! Para utilizá-la aqui deve ser escolhida a opção 'Beneficiário?: Não' .", vbInformation
            txtCodDizer = "0"
            Exit Sub
        End If
    End If
    ...
    If (gM46V999.CDblx(txtCodDizer) = 8695) Or (gM46V999.CDblx(txtCodDizer) = 8696) Then
        For Each lObjstcCorr In frmT46V101A.objstcPedido.ColecaoPedCorr
    ...
    '    If gM46V999.CDblx(txtCodDizer) = gM46V999.CDblx(flxEspec.TextMatrix(lLinha, 1)) Then
    '        MsgBox "Mensagem Padrão '" & txtCodDizer & "' já cadastrada!!", vbInformation
    '        txtCodDizer = "0"
    '        Exit Sub
    '    End If
    'Next

    If Trim(txtCodDizer) = "1" Then
        MsgBox "Numeração restrita, favor utilizar outro código!", vbInformation
        txtCodDizer.Text = ""
        Exit Sub
    End If
    ...
    Else
        ...
        If Trim(txtTextoEspec.Text) <> "" Then
    ...
    If gM46V999.gNovaPropostaLMI And txtCodDizer.Text = 8501 And gM46V999.gTipoAcesso = CALCULO Then
        ...
        Else
            GoTo Fim
        End If
        If frmT46V165A.cboClausulas(1).ListIndex <> -1 Then
            If frmT46V165A.cboClausulas(1).ItemData(frmT46V165A.cboClausulas(1).ListIndex) = lClausula Then GoTo Fim
        Else
            For lI = 0 To frmT46V165A.cboClausulas(1).ListCount
                If frmT46V165A.cboClausulas(1).ItemData(lI) = lClausula Then
                    frmT46V165A.cboClausulas(1).ListIndex = lI
                    GoTo Fim
                End If
            Next lI
        End If
        If frmT46V165A.cboClausulas(2).ListIndex <> -1 Then
            If frmT46V165A.cboClausulas(2).ItemData(frmT46V165A.cboClausulas(2).ListIndex) = lClausula Then GoTo Fim
        Else
            For lI = 0 To frmT46V165A.cboClausulas(2).ListCount
                If frmT46V165A.cboClausulas(2).ItemData(lI) = lClausula Then
                    frmT46V165A.cboClausulas(2).ListIndex = lI
                    GoTo Fim
                End If
            Next lI
        End If
        If frmT46V165A.cboClausulas(3).ListIndex <> -1 Then
            If frmT46V165A.cboClausulas(3).ItemData(frmT46V165A.cboClausulas(3).ListIndex) = lClausula Then GoTo Fim
        Else
            For lI = 0 To frmT46V165A.cboClausulas(3).ListCount
                If frmT46V165A.cboClausulas(3).ItemData(lI) = lClausula Then
                    frmT46V165A.cboClausulas(3).ListIndex = lI
                    GoTo Fim
                End If
            Next lI
        End If
        If frmT46V165A.cboClausulas(4).ListIndex <> -1 Then
            If frmT46V165A.cboClausulas(4).ItemData(frmT46V165A.cboClausulas(4).ListIndex) = lClausula Then GoTo Fim
        Else
            For lI = 0 To frmT46V165A.cboClausulas(4).ListCount
                If frmT46V165A.cboClausulas(4).ItemData(lI) = lClausula Then
                    frmT46V165A.cboClausulas(4).ListIndex = lI
                    GoTo Fim
                End If
            Next lI
        End If
        If frmT46V165A.cboClausulas(5).ListIndex <> -1 Then
            If frmT46V165A.cboClausulas(5).ItemData(frmT46V165A.cboClausulas(5).ListIndex) = lClausula Then GoTo Fim
        Else
            For lI = 0 To frmT46V165A.cboClausulas(5).ListCount
                If frmT46V165A.cboClausulas(5).ItemData(lI) = lClausula Then
                    frmT46V165A.cboClausulas(5).ListIndex = lI
                    GoTo Fim
                End If
            Next lI
        End If
        If frmT46V165A.cboClausulas(6).ListIndex <> -1 Then
            If frmT46V165A.cboClausulas(6).ItemData(frmT46V165A.cboClausulas(6).ListIndex) = lClausula Then GoTo Fim
        Else
            For lI = 0 To frmT46V165A.cboClausulas(6).ListCount
                If frmT46V165A.cboClausulas(6).ItemData(lI) = lClausula Then
                    frmT46V165A.cboClausulas(6).ListIndex = lI
                    GoTo Fim
                End If
            Next lI
        End If
        If frmT46V165A.cboClausulas(7).ListIndex <> -1 Then
            If frmT46V165A.cboClausulas(7).ItemData(frmT46V165A.cboClausulas(7).ListIndex) = lClausula Then GoTo Fim
        Else
            For lI = 0 To frmT46V165A.cboClausulas(7).ListCount
                If frmT46V165A.cboClausulas(7).ItemData(lI) = lClausula Then
                    frmT46V165A.cboClausulas(7).ListIndex = lI
                    GoTo Fim
                End If
            Next lI
        End If
        If frmT46V165A.cboClausulas(8).ListIndex <> -1 Then
            If frmT46V165A.cboClausulas(8).ItemData(frmT46V165A.cboClausulas(8).ListIndex) = lClausula Then GoTo Fim
        Else
            For lI = 0 To frmT46V165A.cboClausulas(8).ListCount
                If frmT46V165A.cboClausulas(8).ItemData(lI) = lClausula Then
                    frmT46V165A.cboClausulas(8).ListIndex = lI
                    GoTo Fim
                End If
            Next lI
        End If
        If frmT46V165A.cboClausulas(9).ListIndex <> -1 Then
            If frmT46V165A.cboClausulas(9).ItemData(frmT46V165A.cboClausulas(9).ListIndex) = lClausula Then GoTo Fim
        Else
            For lI = 0 To frmT46V165A.cboClausulas(9).ListCount
                If frmT46V165A.cboClausulas(9).ItemData(lI) = lClausula Then
                    frmT46V165A.cboClausulas(9).ListIndex = lI
                    GoTo Fim
                End If
            Next lI
        End If
