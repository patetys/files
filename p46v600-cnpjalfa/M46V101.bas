...
Public gDesabilitaNormas As Boolean
Public gModoFastEndosso As Boolean
...
Public Const DESC_COBERT_PREDIO = " - PRÉDIO"
Public Const DESC_COBERT_CONTEUDO = " - CONTEÚDO"
...
'                                   2 = Bancos para carnê................................1, 033, 399
'                                   3 = Bancos para débito em conta......................1, 237, 341, 033, 047, 399
'                                   4 = Bancos de indicador de seguro....................215, 341, 356
'                                   5 = Bancos para débito em conta para segregados .....1, 237, 341, 033, 047, 399, 422, 756
'                                   6 = Bancos de Restituicao (TBM_BANCOS where restituicao=1)
'                       pCombo......Combo de bancos.
'Parâmetro de saída.....pMensagem...Mensagem.
    
    Dim bdTemp As ADODB.Connection
    Dim lrsBanco As clsYasRecordSet
    ...
    If Not IsNumeric(pOpcao) Then
        ...
        Exit Function
    End If
    If pOpcao <> 1 And pOpcao <> 2 And pOpcao <> 3 And pOpcao <> 4 And pOpcao <> 5 And pOpcao <> 6 Then
    ...
    Case 2      'Bancos para carnê.
        ...
        Case Else
            pCombo.AddItem "0 - Não Definido"
            pCombo.ItemData(pCombo.NewIndex) = 0
    ...
    Case 3      'Bancos para débito em conta
        If gM46V999.gfAbrBasDados("P00MULTI", gM46V999.gTipP00MULTI, "", bdTemp, pMensagem) = False Then
        Call gM46V999.gpGraLog(2, pMensagem)
            GoTo Fim:
        End If
        
        If gM46V999.gfObtRegistro(bdTemp, "exec proc_listarbancos 3, 0", lrsBanco, pMensagem) = False Then
            Call gM46V999.gpGraLog(2, pMensagem)
            GoTo Fim:
        End If
                    
        Do While Not lrsBanco.EOF
            pCombo.AddItem Right(String(3, "0") & lrsBanco!codBanco, 3) & " - " & lrsBanco!NomBanco
            pCombo.ItemData(pCombo.NewIndex) = val("" & lrsBanco!codBanco)
            lrsBanco.MoveNext
        Loop
...
'        pCombo.ItemData(pCombo.NewIndex) = 47
    ...
    Case 5
        ...
        If gM46V999.gfObtRegistro(bdTemp, "exec proc_listarbancos 5, 0", lrsBanco, pMensagem) = False Then
            Call gM46V999.gpGraLog(2, pMensagem)
            GoTo Fim:
        End If
...
'        pCombo.AddItem "047 - BANESE"
'        pCombo.ItemData(pCombo.NewIndex) = 47
'        pCombo.AddItem "422 - SAFRA"
'        pCombo.ItemData(pCombo.NewIndex) = 422
'        pCombo.AddItem "756 - BANCOOB"
'        pCombo.ItemData(pCombo.NewIndex) = 756
    ...
    Case 6
        ...
        If gM46V999.gfObtRegistro(bdTemp, "exec proc_listarbancosrestituicao", lrsBanco, pMensagem) = False Then
        ...
        Do While Not lrsBanco.EOF
            pCombo.AddItem Right(String(3, "0") & lrsBanco!codigo, 3) & " - " & lrsBanco!nomeAbreviado
            pCombo.ItemData(pCombo.NewIndex) = val("" & lrsBanco!codigo)
            lrsBanco.MoveNext
        Loop
    End Select
...
'                        pMensagem.....Mensagem.
    ...
    Case 422    'Safra
        lAuxiliar = Replace$(pNumConta, "-", Empty)
        lAuxiliar = Format$(lAuxiliar, "0000000")
        lAuxiliar = Mid$(lAuxiliar, 1, 6) & "-" & Mid$(lAuxiliar, 7, 1)
    
    Case 756    'BANCOOB
        lAuxiliar = Replace$(pNumConta, "-", Empty)
        lAuxiliar = Format$(lAuxiliar, "0000000000")
        lAuxiliar = Mid$(lAuxiliar, 1, 9) & "-" & Mid$(lAuxiliar, 10, 1)
...
'1. Calcula margens.
    ...
    If gM46V999.gfDisponivel("frmT46V124A") Then
        With frmT46V124A
            .Move lMarEsquerda, lMarSuperior, lLargura, lAltura
            If .tabResultado.TabVisible(0) Then
                .tabResultado.Tab = 0
            End If
        End With
    End If
            ...
            While Not rsTabela.EOF
                ...
                For Each flTabela In rsTabela.Fields
                    ...
                    Case "NOSSO_NUMERO", "COD_UNICIDADE", "ULT_TARIFA", _
                         ...
                         "IND_SIN_INSPEC", "COD_DIZERITEM", "AJUSTEENDOSSO", "IND_VERBASEP", _
                         "NUM_EQUIP", "NOME_EQUIP", "TIPO_EQUIP", "TEL_CONTATO", "LOGRADOURO", _
                         "LOGR_COMPL", "NOME_CONTATO", "LOGR_NUMERO", "CLASSE_EQUIP", "BAIRRO", _
                         "CIDADE", "UF", "CEP", "STATUS", "ANO_FABRICACAO_EQUIP", "MARCA_EQUIP", _
                         "MODELO_EQUIP", "NUM_SERIE_CHASSI_EQUIP"
                    Case "COD_PRODUTO"
            ...
            While Not rsTabela.EOF
                ...
                For Each flTabela In rsTabela.Fields
                    ...
                    Case "NOSSO_NUMERO", "COD_UNICIDADE", "ULT_TARIFA", _
                         ...
                         "NOSSO_NUMERO_ORIGINAL", "IND_SIN_INSPEC", "AJUSTEENDOSSO", "IND_VERBASEP", _
                         "NUM_EQUIP", "NOME_EQUIP", "TIPO_EQUIP", "TEL_CONTATO", "LOGRADOURO", _
                         "LOGR_COMPL", "NOME_CONTATO", "LOGR_NUMERO", "CLASSE_EQUIP", "BAIRRO", _
                         "CIDADE", "UF", "CEP", "STATUS", "ANO_FABRICACAO_EQUIP", "MARCA_EQUIP", _
                         "MODELO_EQUIP", "NUM_SERIE_CHASSI_EQUIP"
                ...
                For Each flTabela In rsTabela.Fields
                    ...
                    Case "NOSSO_NUMERO", "COD_UNICIDADE", "ULT_TARIFA", _
                         ...
                         "PER_DESC_LMI", "LMI_UNICO", "NUM_COTAC_LMI", _
                         "COD_REG_CONS", "NUM_REG_CONS", "IND_CONDGERAIS", "IND_REENTRADA", _
                         "NOSSO_NUMERO_ORIGINAL", "IND_SIN_INSPEC", "COD_DIZERITEM", _
                         "NUM_EQUIP", "NOME_EQUIP", "TIPO_EQUIP", "TEL_CONTATO", "LOGRADOURO", _
                         "LOGR_COMPL", "NOME_CONTATO", "LOGR_NUMERO", "CLASSE_EQUIP", "BAIRRO", _
                         "CIDADE", "UF", "CEP", "STATUS", "ANO_FABRICACAO_EQUIP", "MARCA_EQUIP", _
                         "MODELO_EQUIP", "NUM_SERIE_CHASSI_EQUIP"
